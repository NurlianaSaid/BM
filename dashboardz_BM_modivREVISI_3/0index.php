    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="0index.php">
                ...
                <div class="sidebar-brand-text mx-1 mt-1" href="">HALAMAN ADMIN</div>  
            </a>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <a class="nav-link1" href="index.html" aria-label="Dashboard">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-black-500" style="color: #000; font-weight: 500px;">WELCOME TO HALAMAN ADMIN </h1>
                        </div>
