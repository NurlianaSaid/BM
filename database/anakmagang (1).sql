...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Nov 2024 pada 15.40
...
(4, '0001', 3, '2024-09-30', 'Monitoring Kedua', 'belum selesai'),
...
INSERT INTO `tb_siswa` (`Id_siswaa`, `Nisn`, `Nama_siswa`, `Kelas_siswa`, `Jenis_kelamin`, `Foto_siswa`, `Alamat`) VALUES
(1, '220186', 'Nurliana', 'XI RPL', 'P', 'liana.jpg', 'Lelupang'),
(2, '220160', 'Dian', 'XI RPL', 'P', 'dian.jpg', 'Gonda');
...
--
ALTER TABLE `tb_siswa`
  MODIFY `Id_siswaa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tb_jurnal`
  ADD CONSTRAINT `tb_jurnal_ibfk_1` FOREIGN KEY (`id_siswa`) REFERENCES `siswa_pkl` (`id_siswa`) ON DELETE CASCADE ON UPDATE CASCADE,
